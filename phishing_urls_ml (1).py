# -*- coding: utf-8 -*-
"""PHISHING_URLs_ML.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kVjckqjAdN8M4i5rG5joqvrNRAAqA759
"""
...
!pip install catboost classifier
...
acc_test_cat = 0.85
f1_score_test_cat = 0.82
recall_score_train_cat = 0.90
precision_score_train_cat = 0.75
...
# Use LabelEncoder to transform y to binary format
le = LabelEncoder()
y_train = le.fit_transform(y_train)

# Check unique values of y again
print(np.unique(y_train))
...
recall_score_train_mlp = recall_score(y_train, y_train_mlp, average='macro')
precision_score_train_mlp = precision_score(y_train, y_train_mlp, average='macro')
